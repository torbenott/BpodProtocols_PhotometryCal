...
if isempty(fieldnames(TaskParameters))
    ...
    TaskParameters.GUI.BaselineBegin=0;
    TaskParameters.GUI.BaselineEnd=1;
    ...
    %% rig-specific
        ...
        TaskParameters.GUI.LED1Amp=2;
        TaskParameters.GUI.LED2Amp=2;
        TaskParameters.GUI.LED1bAmp=2;
        
        TaskParameters.GUIPanels.PhotometryRig={'nidaqDev','LED1Amp','LED2Amp','LED1bAmp'};
...
while RunSession
    ...
    % plot photometry data
        [currentNidaq1, rawNidaq1]=Online_NidaqDemod(PhotoData(:,1),nidaq.LED1,TaskParameters.GUI.LED1_Freq,TaskParameters.GUI.LED1_Amp,TaskParameters.Names.StateToZero{TaskParameters.GUI.StateToZero});
    ...
    if TaskParameters.GUI.Isobestic405 || TaskParameters.GUI.DbleFibers || TaskParameters.GUI.RedChannel
        ...
        [currentNidaq2, rawNidaq2]=Online_NidaqDemod(PhotoData(:,1),nidaq.LED2,TaskParameters.GUI.LED2_Freq,TaskParameters.GUI.LED2_Amp,TaskParameters.Names.StateToZero{TaskParameters.GUI.StateToZero});
        elseif TaskParameters.GUI.RedChannel
        [currentNidaq2, rawNidaq2]=Online_NidaqDemod(Photo2Data(:,1),nidaq.LED2,TaskParameters.GUI.LED2_Freq,TaskParameters.GUI.LED2_Amp,TaskParameters.Names.StateToZero{TaskParameters.GUI.StateToZero});
        elseif TaskParameters.GUI.DbleFibers
        [currentNidaq2, rawNidaq2]=Online_NidaqDemod(Photo2Data(:,1),nidaq.LED2,TaskParameters.GUI.LED1b_Freq,TaskParameters.GUI.LED1b_Amp,TaskParameters.Names.StateToZero{TaskParameters.GUI.StateToZero});
        end
